...
#define luai_jmpbuf d_err_jmpbuf

void disco_throw_function(luai_jmpbuf * c) {
}
...
void disco_try_function(luai_jmpbuf * c, void (*f)(void *, void *), void * ud) {
}

#define LUAI_THROW(L, c)  disco_throw_function((c))
#define LUAI_TRY(L, c, a) disco_try_function((c), (a), (void *)(L))
